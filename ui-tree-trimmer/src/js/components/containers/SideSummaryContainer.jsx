  ...
  render() {
    ...
    return (
      <Box className='side-summary-container'
        ...
        {this.props.showNodeSummary ? <NodeSummary nodeData={this.props.nodeData} nodeIsLeaf={this.props.nodeIsLeaf} updateParameters={this.props.updateParameters}/> : null}
      </Box>
    );
  }
};
